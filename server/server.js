...
const frontendOrigin = process.env.FRONTEND_URL ? process.env.FRONTEND_URL.replace(/\/$/, '') : defaultFrontend;
const corsOptions = {
  origin: [frontendOrigin, process.env.FRONTEND_URL, 'http://localhost:5173'],
  credentials: true,
